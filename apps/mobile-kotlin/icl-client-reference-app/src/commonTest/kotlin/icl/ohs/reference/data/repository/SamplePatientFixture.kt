...
/**
 * Patient "p1" (Amina Diallo) and related clinical resources, for UI tests - replaces the bundled
 * `SampleResourcesBundle.json` that [PatientRepository] used to auto-seed on first access.
 * Production builds no longer auto-seed; tests that need patient data seed this fixture directly
 * via [InMemoryFhirRepository.upsert].
 */
